  ...
  return new Promise(function(resolve, reject){
    ...
    function _createOrganizationTable(){
      return new Promise(function(_resolve, _reject){
        ...
        query += 'id INT(10) NOT NULL AUTO_INCREMENT, ';
        query += 'name VARCHAR(2048) NULL, ';
        query += 'status VARCHAR (2048) NULL, ';
        query += 'PRIMARY KEY (id)';
        query += ')';
...
function _defaultConfig(config){
  ...
  this.theme_head += '\n<!--load stylesheets-->\n';
  this.theme_head += '<link rel="stylesheet" href="/css/bootstrap.min.css">\n';
  ...
  this.theme_head += '\t\t<script src="/js/html5shiv.min.js"></script>\n';
  ...
  this.theme_section_header += '\t\t\t\t<button class="navbar-toggle collapsed" type="button" data-toggle="collapse" data-target="#navbar-collapse">\n';
  ...
  this.theme_section_header += '\t\t\t<div class="collapse navbar-collapse" id="navbar-collapse">\n';
  ...
  this.theme_section_bottomscripts += '\t<script src="/js/jquery.min.js"></script>\n';
  this.theme_section_bottomscripts += '\t<script src="/js/bootstrap.min.js"></script>\n';
  ...
  this.theme_section_bottomscripts += '\t[theme_tinymce]\n';
